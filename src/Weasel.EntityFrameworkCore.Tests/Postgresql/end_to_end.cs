...
public class end_to_end : IAsyncLifetime
{
    ...
    public async Task can_create_table_and_verify_schema()
    {
        ...
        var entity = new MyEntity
        {
            ...
            DateTimeOffsetValue = new DateTimeOffset(2024, 1, 15, 10, 30, 0, TimeSpan.Zero),
            ...
            NullableDateTimeValue = new DateTime(2024, 6, 1, 14, 0, 0, DateTimeKind.Utc),
    ...
    public async Task can_create_migration_and_apply()
    {
        ...
        migration.Migrator.ShouldBeOfType<PostgresqlMigrator>();

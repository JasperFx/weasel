...
public class BatchBuilder: ICommandBuilder
{
    ...
    private SqlBatchCommand? _current;

    public BatchBuilder(SqlBatch batch)
    {
        _batch = batch;
    }
    ...
    private SqlBatchCommand appendCommand()
    {
        var command = (SqlBatchCommand)_batch.CreateBatchCommand();
    ...
    /// <returns></returns>
    public SqlParameter[] AppendWithParameters(string text)
    {
    ...
    public void AddParameters(object parameters)
    {
        ...
        foreach (var property in properties)
        {
            ...
            _current.Parameters.Add(new SqlParameter { Value = value ?? DBNull.Value, ParameterName = property.Name });
        }
    }
    ...
    public void AddParameters<T>(IDictionary<string, T> parameters)
    {
        ...
        {
            _current.Parameters.Add(new SqlParameter { Value = (object?)value ?? DBNull.Value, ParameterName = key });
        }
    }

    public SqlBatch Compile()
    {

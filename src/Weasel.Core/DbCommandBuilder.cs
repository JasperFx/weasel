...
namespace Weasel.Core
{
        ...
        DbDataReader>
    {
        ...
        protected override void storeMappings()
        {
            ...
            store<bool>(System.Data.DbType.Boolean, "bit");
            store<long>(System.Data.DbType.Int64, "bigint");
            store<byte[]>(System.Data.DbType.Binary, "binary");
            store<DateTime>(System.Data.DbType.Date, "datetime");
            store<DateTimeOffset>(System.Data.DbType.DateTimeOffset, "datetimeoffset");
            store<decimal>(System.Data.DbType.Decimal, "decimal");
            store<double>(System.Data.DbType.Double, "float");

...
public class SchemaMigrationTests
{
    ...
    [InlineData(AutoCreate.All,
        new[] { SchemaPatchDifference.None, SchemaPatchDifference.None, SchemaPatchDifference.None })]
    [InlineData(AutoCreate.All,
        new[] { SchemaPatchDifference.Invalid, SchemaPatchDifference.None, SchemaPatchDifference.None })]
    [InlineData(AutoCreate.All,
        new[] { SchemaPatchDifference.Create, SchemaPatchDifference.None, SchemaPatchDifference.None })]
    [InlineData(AutoCreate.All,
        new[] { SchemaPatchDifference.Update, SchemaPatchDifference.None, SchemaPatchDifference.None })]
    [InlineData(AutoCreate.None,
        new[] { SchemaPatchDifference.None, SchemaPatchDifference.None, SchemaPatchDifference.None })]
    [InlineData(AutoCreate.None,
        new[] { SchemaPatchDifference.Create, SchemaPatchDifference.None, SchemaPatchDifference.None })]
    [InlineData(AutoCreate.None,
    ...
    [InlineData(AutoCreate.CreateOnly,
        new[] { SchemaPatchDifference.Create, SchemaPatchDifference.None, SchemaPatchDifference.None })]
    [InlineData(AutoCreate.CreateOnly,
        new[] { SchemaPatchDifference.Create, SchemaPatchDifference.Create, SchemaPatchDifference.None })]
    ...
    [InlineData(AutoCreate.CreateOrUpdate,
        new[] { SchemaPatchDifference.Update, SchemaPatchDifference.None, SchemaPatchDifference.None })]
    [InlineData(AutoCreate.CreateOrUpdate,
        new[] { SchemaPatchDifference.Update, SchemaPatchDifference.Create, SchemaPatchDifference.None })]
    ...
    [InlineData(AutoCreate.CreateOrUpdate,
        new[] { SchemaPatchDifference.Invalid, SchemaPatchDifference.None, SchemaPatchDifference.None })]
    [InlineData(AutoCreate.CreateOrUpdate,
        new[] { SchemaPatchDifference.Create, SchemaPatchDifference.Invalid, SchemaPatchDifference.None })]
    [InlineData(AutoCreate.CreateOrUpdate,
        new[] { SchemaPatchDifference.Update, SchemaPatchDifference.Invalid, SchemaPatchDifference.None })]
    [InlineData(AutoCreate.CreateOrUpdate,
        new[] { SchemaPatchDifference.Update, SchemaPatchDifference.Create, SchemaPatchDifference.Invalid })]
